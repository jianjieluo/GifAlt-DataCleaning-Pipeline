start /wait python 1_precook_data_multi_process.py --src merge_gif_alt_info_all --num_worker 5
start /wait python 2_pos_tags_multi_process.py --num_worker 5 --src gif_alt_info_clean --backend spacy
